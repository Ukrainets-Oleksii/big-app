...
public class TestController {
    ...
    public String doEmotionForTopic(
        ...
        topicService.doEmotion(id, username); //TODO!!!!!!!!!!!!!
        return "Completed!";
    }

//    @GetMapping("/doEmotionForComment/{id}")
//    public String doEmotionForComment(Authentication authentication, @PathVariable Long id) {
//        topicService.doEmotion(id, authentication); //TODO!!!!!!!!!!!!!
//        return "Completed!";
//    }
